...
router.get('/current-round', auth, betController.getCurrentRound);
router.get('/rounds', auth, betController.getAllRounds);
router.put('/rounds/:period/outcome', auth, betController.setRoundOutcome);
